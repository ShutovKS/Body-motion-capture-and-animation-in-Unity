...
namespace Example_2___IK_Animation.SAFullBodyIK.FullBody
{
	public partial class FullBodyIK
	{
		public class FingerIK
		{
			...
			SAFullBodyIK.FullBodyIK.Settings _settings;
			SAFullBodyIK.FullBodyIK.InternalValues _internalValues;
			...
			public FingerIK( SAFullBodyIK.FullBodyIK fullBodyIK, FingerIKType fingerIKType )
			{
				_fingerIKType = fingerIKType;
				_settings = fullBodyIK.settings;
				_internalValues = fullBodyIK.internalValues;

				SAFullBodyIK.FullBodyIK.FingersBones fingerBones = null;
                SAFullBodyIK.FullBodyIK.FingersEffectors fingerEffectors = null;
				switch( fingerIKType ) {
			...
			void _SyncDisplacement()
			{
				...
				if( _settings.syncDisplacement == SAFullBodyIK.FullBodyIK.SyncDisplacement.Everyframe || !_isSyncDisplacementAtLeastOnce ) {
			...
			static Vector3 _GetEffectorPosition(
				SAFullBodyIK.FullBodyIK.InternalValues internalValues,
				Bone rootBone,
				Bone beginLinkBone,
				Effector effector,
