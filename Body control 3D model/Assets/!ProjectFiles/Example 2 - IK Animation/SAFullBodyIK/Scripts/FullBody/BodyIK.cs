...
namespace Example_2___IK_Animation.SAFullBodyIK.FullBody
{
	public partial class FullBodyIK
	{
		public class BodyIK
		{
			...
			public BodyIK( SAFullBodyIK.FullBodyIK fullBodyIK, LimbIK[] limbIK )
			{
			...
			void _Prepare( SAFullBodyIK.FullBodyIK fullBodyIK )
			{
				if( _spineBones != null ) {
					int spineLength = _spineBones.Length;
			...
			class SolverInternal
			{
				...
				public SAFullBodyIK.FullBodyIK.Settings settings;
				public SAFullBodyIK.FullBodyIK.InternalValues internalValues;
