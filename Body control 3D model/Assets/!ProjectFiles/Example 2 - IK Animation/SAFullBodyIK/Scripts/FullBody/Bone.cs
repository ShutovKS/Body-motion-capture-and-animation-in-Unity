...
namespace Example_2___IK_Animation.SAFullBodyIK.FullBody
{
	public partial class FullBodyIK
	{
		...
		public class Bone
		{
			...
			public void Prepare( SAFullBodyIK.FullBodyIK fullBodyIK )
			{
			...
			void _ComputeLocalAxis( SAFullBodyIK.FullBodyIK fullBodyIK )
			{
							...
							if( _parentBone._localAxisFrom == _LocalAxisFrom.Child ) {
								if( _parentBone._boneType == BoneType.Shoulder ) {
									...
									if( fullBodyIK.internalValues.shoulderDirYAsNeck == -1 ) {
										if( fullBodyIK.settings.shoulderDirYAsNeck == SAFullBodyIK.FullBodyIK.AutomaticBool.Auto ) {
											...
											fullBodyIK.internalValues.shoulderDirYAsNeck = (fullBodyIK.settings.shoulderDirYAsNeck != SAFullBodyIK.FullBodyIK.AutomaticBool.Disable) ? 1 : 0;
                                        }
									}
			...
			public void PostSyncDisplacement( SAFullBodyIK.FullBodyIK fullBodyIK )
			{
				if( _boneLocation == BoneLocation.Hips ) {
