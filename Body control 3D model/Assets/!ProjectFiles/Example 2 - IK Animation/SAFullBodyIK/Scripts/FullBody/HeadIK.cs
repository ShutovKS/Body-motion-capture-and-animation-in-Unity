...
namespace Example_2___IK_Animation.SAFullBodyIK.FullBody
{
	public partial class FullBodyIK
	{
		public class HeadIK
		{
			...
			public HeadIK( SAFullBodyIK.FullBodyIK fullBodyIK )
			{
			...
			void _SyncDisplacement( SAFullBodyIK.FullBodyIK fullBodyIK )
			{
			...
			public bool Solve( SAFullBodyIK.FullBodyIK fullBodyIK )
			{
			...
			void _Solve( SAFullBodyIK.FullBodyIK fullBodyIK )
			{
				Quaternion parentWorldRotation = _neckBone.parentBone.worldRotation;
