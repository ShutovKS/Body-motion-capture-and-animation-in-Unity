...
namespace Example_2___IK_Animation.SAFullBodyIK
{
	...
	public partial class FullBodyIK
	{
		...
		{
			public FullBody.FullBodyIK.Bone hips;
			public FullBody.FullBodyIK.Bone spine;
			public FullBody.FullBodyIK.Bone spine2;
			public FullBody.FullBodyIK.Bone spine3;
			public FullBody.FullBodyIK.Bone spine4;

			public FullBody.FullBodyIK.Bone spineU { get { return spine4; } }
		}

		[System.Serializable]
		public class HeadBones
		{
			public FullBody.FullBodyIK.Bone neck;
			public FullBody.FullBodyIK.Bone head;
			public FullBody.FullBodyIK.Bone leftEye;
			public FullBody.FullBodyIK.Bone rightEye;
		}

		[System.Serializable]
		public class LegBones
		{
			public FullBody.FullBodyIK.Bone leg;
			public FullBody.FullBodyIK.Bone knee;
			public FullBody.FullBodyIK.Bone foot;
		}

		[System.Serializable]
		public class ArmBones
		{
			public FullBody.FullBodyIK.Bone shoulder;
			public FullBody.FullBodyIK.Bone arm;
			public FullBody.FullBodyIK.Bone[] armRoll;
			public FullBody.FullBodyIK.Bone elbow;
			public FullBody.FullBodyIK.Bone[] elbowRoll;
			public FullBody.FullBodyIK.Bone wrist;

			public void Repair()
			{
				FullBody.FullBodyIK.SafeResize( ref armRoll, FullBody.FullBodyIK.MaxArmRollLength );
				FullBody.FullBodyIK.SafeResize( ref elbowRoll, FullBody.FullBodyIK.MaxElbowRollLength );
			}
		}
		...
		{
			public FullBody.FullBodyIK.Bone[] thumb;
			public FullBody.FullBodyIK.Bone[] index;
			public FullBody.FullBodyIK.Bone[] middle;
			public FullBody.FullBodyIK.Bone[] ring;
			public FullBody.FullBodyIK.Bone[] little;

			public void Repair()
			{
				FullBody.FullBodyIK.SafeResize( ref thumb, FullBody.FullBodyIK.MaxHandFingerLength );
				FullBody.FullBodyIK.SafeResize( ref index, FullBody.FullBodyIK.MaxHandFingerLength );
				FullBody.FullBodyIK.SafeResize( ref middle, FullBody.FullBodyIK.MaxHandFingerLength );
				FullBody.FullBodyIK.SafeResize( ref ring, FullBody.FullBodyIK.MaxHandFingerLength );
				FullBody.FullBodyIK.SafeResize( ref little, FullBody.FullBodyIK.MaxHandFingerLength );
		...
		{
			public FullBody.FullBodyIK.Effector hips;
		}

		[System.Serializable]
		public class HeadEffectors
		{
			public FullBody.FullBodyIK.Effector neck;
			public FullBody.FullBodyIK.Effector head;
			public FullBody.FullBodyIK.Effector eyes;
		}

		[System.Serializable]
		public class LegEffectors
		{
			public FullBody.FullBodyIK.Effector knee;
			public FullBody.FullBodyIK.Effector foot;
		}

		[System.Serializable]
		public class ArmEffectors
		{
			public FullBody.FullBodyIK.Effector arm;
			public FullBody.FullBodyIK.Effector elbow;
			public FullBody.FullBodyIK.Effector wrist;
		}

		[System.Serializable]
		public class FingersEffectors
		{
			public FullBody.FullBodyIK.Effector thumb;
			public FullBody.FullBodyIK.Effector index;
			public FullBody.FullBodyIK.Effector middle;
			public FullBody.FullBodyIK.Effector ring;
			public FullBody.FullBodyIK.Effector little;
		}
		...
		public class Settings
		{
			...
			public void Prefix()
			{
				FullBody.FullBodyIK.SafeNew( ref bodyIK );
				FullBody.FullBodyIK.SafeNew( ref limbIK );
				FullBody.FullBodyIK.SafeNew( ref headIK );
				FullBody.FullBodyIK.SafeNew( ref fingerIK );
			}
		}
		...
		public class InternalValues
		{
			...
			public FullBody.FullBodyIK.Matrix3x3 defaultRootBasis = FullBody.FullBodyIK.Matrix3x3.identity;
			public FullBody.FullBodyIK.Matrix3x3 defaultRootBasisInv = FullBody.FullBodyIK.Matrix3x3.identity;
			...
			public FullBody.FullBodyIK.Matrix3x3 baseHipsBasis = FullBody.FullBodyIK.Matrix3x3.identity;
			...
			public class BodyIK
			{
				public FullBody.FullBodyIK.CachedDegreesToSin shoulderLimitThetaYPlus = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin shoulderLimitThetaYMinus = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin shoulderLimitThetaZ = FullBody.FullBodyIK.CachedDegreesToSin.zero;

				public FullBody.FullBodyIK.CachedRate01 upperCenterLegTranslateRate = FullBody.FullBodyIK.CachedRate01.zero;
				public FullBody.FullBodyIK.CachedRate01 upperSpineTranslateRate = FullBody.FullBodyIK.CachedRate01.zero;

				public FullBody.FullBodyIK.CachedRate01 upperPreTranslateRate = FullBody.FullBodyIK.CachedRate01.zero;
				public FullBody.FullBodyIK.CachedRate01 upperPostTranslateRate = FullBody.FullBodyIK.CachedRate01.zero;

				public FullBody.FullBodyIK.CachedRate01 upperCenterLegRotateRate = FullBody.FullBodyIK.CachedRate01.zero;
				public FullBody.FullBodyIK.CachedRate01 upperSpineRotateRate = FullBody.FullBodyIK.CachedRate01.zero;
				public bool isFuzzyUpperCenterLegAndSpineRotationRate = true;

				public FullBody.FullBodyIK.CachedDegreesToSin upperEyesLimitYaw = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin upperEyesLimitPitchUp = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin upperEyesLimitPitchDown = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToCos upperEyesTraceTheta = FullBody.FullBodyIK.CachedDegreesToCos.zero;

				public FullBody.FullBodyIK.CachedDegreesToSin upperDirXLimitThetaY = FullBody.FullBodyIK.CachedDegreesToSin.zero;

				public FullBody.FullBodyIK.CachedScaledValue spineLimitAngleX = FullBody.FullBodyIK.CachedScaledValue.zero; // Mathf.Deg2Rad(Not sin)
				public FullBody.FullBodyIK.CachedScaledValue spineLimitAngleY = FullBody.FullBodyIK.CachedScaledValue.zero; // Mathf.Deg2Rad(Not sin)

				public FullBody.FullBodyIK.CachedRate01 upperContinuousPreTranslateRate = FullBody.FullBodyIK.CachedRate01.zero;
				public FullBody.FullBodyIK.CachedRate01 upperContinuousPreTranslateStableRate = FullBody.FullBodyIK.CachedRate01.zero;
				public FullBody.FullBodyIK.CachedRate01 upperContinuousCenterLegRotationStableRate = FullBody.FullBodyIK.CachedRate01.zero;
				public FullBody.FullBodyIK.CachedRate01 upperContinuousPostTranslateStableRate = FullBody.FullBodyIK.CachedRate01.zero;

				public void Update( Settings.BodyIK settingsBodyIK )
				{
					// Optimize: Reduce C# fuction call.
					FullBody.FullBodyIK.Assert( settingsBodyIK != null );
					...
					if( upperCenterLegRotateRate._value != settingsBodyIK.upperCenterLegRotateRate ||
						...
						isFuzzyUpperCenterLegAndSpineRotationRate = FullBody.FullBodyIK.IsFuzzy( upperCenterLegRotateRate.value, upperSpineRotateRate.value );
					}
			...
			public class LimbIK
			{
				public FullBody.FullBodyIK.CachedDegreesToSin armEffectorBackBeginTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin armEffectorBackCoreBeginTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToCos armEffectorBackCoreEndTheta = FullBody.FullBodyIK.CachedDegreesToCos.zero;
				public FullBody.FullBodyIK.CachedDegreesToCos armEffectorBackEndTheta = FullBody.FullBodyIK.CachedDegreesToCos.zero;

				public FullBody.FullBodyIK.CachedDegreesToSin armEffectorBackCoreUpperTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin armEffectorBackCoreLowerTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;

				public FullBody.FullBodyIK.CachedDegreesToSin elbowFrontInnerLimitTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin elbowBackInnerLimitTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;

				public FullBody.FullBodyIK.CachedDegreesToSin footLimitYawTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin footLimitPitchUpTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin footLimitPitchDownTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin footLimitRollTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;

				public void Update( Settings.LimbIK settingsLimbIK )
				{
					// Optimize: Reduce C# fuction call.
					FullBody.FullBodyIK.Assert( settingsLimbIK != null );
			...
			public class HeadIK
			{
				public FullBody.FullBodyIK.CachedDegreesToSin neckLimitPitchUpTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin neckLimitPitchDownTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin neckLimitRollTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;

				public FullBody.FullBodyIK.CachedDegreesToSin headLimitYawTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin headLimitPitchUpTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin headLimitPitchDownTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin headLimitRollTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;

				public FullBody.FullBodyIK.CachedDegreesToCos eyesTraceTheta = FullBody.FullBodyIK.CachedDegreesToCos.zero;

				public FullBody.FullBodyIK.CachedDegreesToSin eyesLimitYawTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;
				public FullBody.FullBodyIK.CachedDegreesToSin eyesLimitPitchTheta = FullBody.FullBodyIK.CachedDegreesToSin.zero;

				public void Update( Settings.HeadIK settingsHeadIK )
				{
					FullBody.FullBodyIK.Assert( settingsHeadIK != null );
		...
		public class BoneCaches
		{
			...
			void _PrepareHipsToFootLength( int index, FullBody.FullBodyIK.Bone legBone, FullBody.FullBodyIK.Bone kneeBone, FullBody.FullBodyIK.Bone footBone, InternalValues internalValues )
			{
				FullBody.FullBodyIK.Assert( internalValues != null );
				if( legBone != null && kneeBone != null && footBone != null ) {
					...
					FullBody.FullBodyIK.SAFBIKMatMultVec( out hipsToFootLength[index].hipsToLeg, ref internalValues.defaultRootBasisInv, ref hipsToLegDir );
					FullBody.FullBodyIK.SAFBIKMatMultVec( out hipsToFootLength[index].legToKnee, ref internalValues.defaultRootBasisInv, ref legToKneeDir );
					FullBody.FullBodyIK.SAFBIKMatMultVec( out hipsToFootLength[index].kneeToFoot, ref internalValues.defaultRootBasisInv, ref kneeToFootDir );
			...
			Vector3 _GetHipsOffset( int index, FullBody.FullBodyIK.Bone legBone, FullBody.FullBodyIK.Bone kneeBone, FullBody.FullBodyIK.Bone footBone )
			{
				if( legBone != null && kneeBone != null && footBone != null ) {
					float hipsToLegLen = legBone._defaultLocalLength.length;
					float legToKneeLen = kneeBone._defaultLocalLength.length;
			...
			{
				FullBody.FullBodyIK.Assert( fullBodyIK != null );
		...
		public FullBody.FullBodyIK.Effector rootEffector;
		...
		public FullBody.FullBodyIK.Bone[] bones { get { return _bones; } }
		public FullBody.FullBodyIK.Effector[] effectors { get { return _effectors; } }

		FullBody.FullBodyIK.Bone[] _bones = new FullBody.FullBodyIK.Bone[(int)FullBody.FullBodyIK.BoneType.Max];
		FullBody.FullBodyIK.Effector[] _effectors = new FullBody.FullBodyIK.Effector[(int)FullBody.FullBodyIK.EffectorLocation.Max];

		FullBody.FullBodyIK.BodyIK _bodyIK;
		FullBody.FullBodyIK.LimbIK[] _limbIK = new FullBody.FullBodyIK.LimbIK[(int)FullBody.FullBodyIK.LimbIKLocation.Max];
		FullBody.FullBodyIK.HeadIK _headIK;
		FullBody.FullBodyIK.FingerIK[] _fingerIK = new FullBody.FullBodyIK.FingerIK[(int)FullBody.FullBodyIK.FingerIKType.Max];
		...
		static void _SetBoneTransform( ref FullBody.FullBodyIK.Bone bone, Transform transform )
		{
			if( bone == null ) {
				bone = new FullBody.FullBodyIK.Bone();
			}

			bone.transform = transform;
		}

		static void _SetFingerBoneTransform( ref FullBody.FullBodyIK.Bone[] bones, Transform[,] transforms, int index )
		{
			if( bones == null || bones.Length != FullBody.FullBodyIK.MaxHandFingerLength ) {
				bones = new FullBody.FullBodyIK.Bone[FullBody.FullBodyIK.MaxHandFingerLength];
			}

			for( int i = 0; i != FullBody.FullBodyIK.MaxHandFingerLength; ++i ) {
				if( bones[i] == null ) {
					bones[i] = new FullBody.FullBodyIK.Bone();
				}
		...
		void _Prefix()
		{
			...
			FullBody.FullBodyIK.SafeNew( ref bodyBones );
			FullBody.FullBodyIK.SafeNew( ref headBones );
			FullBody.FullBodyIK.SafeNew( ref leftLegBones );
			FullBody.FullBodyIK.SafeNew( ref rightLegBones );

			FullBody.FullBodyIK.SafeNew( ref leftArmBones );
			leftArmBones.Repair();
			FullBody.FullBodyIK.SafeNew( ref rightArmBones );
			rightArmBones.Repair();

			FullBody.FullBodyIK.SafeNew( ref leftHandFingersBones );
			leftHandFingersBones.Repair();
			FullBody.FullBodyIK.SafeNew( ref rightHandFingersBones );
			rightHandFingersBones.Repair();

			FullBody.FullBodyIK.SafeNew( ref bodyEffectors );
			FullBody.FullBodyIK.SafeNew( ref headEffectors );
			FullBody.FullBodyIK.SafeNew( ref leftArmEffectors );
			FullBody.FullBodyIK.SafeNew( ref rightArmEffectors );
			FullBody.FullBodyIK.SafeNew( ref leftLegEffectors );
			FullBody.FullBodyIK.SafeNew( ref rightLegEffectors );
			FullBody.FullBodyIK.SafeNew( ref leftHandFingersEffectors );
			FullBody.FullBodyIK.SafeNew( ref rightHandFingersEffectors );

			FullBody.FullBodyIK.SafeNew( ref settings );
			FullBody.FullBodyIK.SafeNew( ref editorSettings );
			FullBody.FullBodyIK.SafeNew( ref internalValues );

			settings.Prefix();

			if( _bones == null || _bones.Length != (int)FullBody.FullBodyIK.BoneLocation.Max ) {
				_bones = new FullBody.FullBodyIK.Bone[(int)FullBody.FullBodyIK.BoneLocation.Max];
			}
			if( _effectors == null || _effectors.Length != (int)FullBody.FullBodyIK.EffectorLocation.Max ) {
				_effectors = new FullBody.FullBodyIK.Effector[(int)FullBody.FullBodyIK.EffectorLocation.Max];
			}

			_Prefix( ref bodyBones.hips, FullBody.FullBodyIK.BoneLocation.Hips, null );
			_Prefix( ref bodyBones.spine, FullBody.FullBodyIK.BoneLocation.Spine, bodyBones.hips );
			_Prefix( ref bodyBones.spine2, FullBody.FullBodyIK.BoneLocation.Spine2, bodyBones.spine );
			_Prefix( ref bodyBones.spine3, FullBody.FullBodyIK.BoneLocation.Spine3, bodyBones.spine2 );
			_Prefix( ref bodyBones.spine4, FullBody.FullBodyIK.BoneLocation.Spine4, bodyBones.spine3 );
			_Prefix( ref headBones.neck, FullBody.FullBodyIK.BoneLocation.Neck, bodyBones.spineU );
			_Prefix( ref headBones.head, FullBody.FullBodyIK.BoneLocation.Head, headBones.neck );
			_Prefix( ref headBones.leftEye, FullBody.FullBodyIK.BoneLocation.LeftEye, headBones.head );
			_Prefix( ref headBones.rightEye, FullBody.FullBodyIK.BoneLocation.RightEye, headBones.head );
			for( int i = 0; i != 2; ++i ) {
				var legBones = (i == 0) ? leftLegBones : rightLegBones;
				_Prefix( ref legBones.leg, (i == 0) ? FullBody.FullBodyIK.BoneLocation.LeftLeg : FullBody.FullBodyIK.BoneLocation.RightLeg, bodyBones.hips );
				_Prefix( ref legBones.knee, (i == 0) ? FullBody.FullBodyIK.BoneLocation.LeftKnee : FullBody.FullBodyIK.BoneLocation.RightKnee, legBones.leg );
				_Prefix( ref legBones.foot, (i == 0) ? FullBody.FullBodyIK.BoneLocation.LeftFoot : FullBody.FullBodyIK.BoneLocation.RightFoot, legBones.knee );

				var armBones = (i == 0) ? leftArmBones : rightArmBones;
				_Prefix( ref armBones.shoulder, (i == 0) ? FullBody.FullBodyIK.BoneLocation.LeftShoulder : FullBody.FullBodyIK.BoneLocation.RightShoulder, bodyBones.spineU );
				_Prefix( ref armBones.arm, (i == 0) ? FullBody.FullBodyIK.BoneLocation.LeftArm : FullBody.FullBodyIK.BoneLocation.RightArm, armBones.shoulder );
				_Prefix( ref armBones.elbow, (i == 0) ? FullBody.FullBodyIK.BoneLocation.LeftElbow : FullBody.FullBodyIK.BoneLocation.RightElbow, armBones.arm );
				_Prefix( ref armBones.wrist, (i == 0) ? FullBody.FullBodyIK.BoneLocation.LeftWrist : FullBody.FullBodyIK.BoneLocation.RightWrist, armBones.elbow );

				for( int n = 0; n != FullBody.FullBodyIK.MaxArmRollLength; ++n ) {
					var armRollLocation = (i == 0) ? FullBody.FullBodyIK.BoneLocation.LeftArmRoll0 : FullBody.FullBodyIK.BoneLocation.RightArmRoll0;
					_Prefix( ref armBones.armRoll[n], (FullBody.FullBodyIK.BoneLocation)((int)armRollLocation + n), armBones.arm );
				}

				for( int n = 0; n != FullBody.FullBodyIK.MaxElbowRollLength; ++n ) {
					var elbowRollLocation = (i == 0) ? FullBody.FullBodyIK.BoneLocation.LeftElbowRoll0 : FullBody.FullBodyIK.BoneLocation.RightElbowRoll0;
					_Prefix( ref armBones.elbowRoll[n], (FullBody.FullBodyIK.BoneLocation)((int)elbowRollLocation + n), armBones.elbow );
				}

				var fingerBones = (i == 0) ? leftHandFingersBones : rightHandFingersBones;
				for( int n = 0; n != FullBody.FullBodyIK.MaxHandFingerLength; ++n ) {
					var thumbLocation = (i == 0) ? FullBody.FullBodyIK.BoneLocation.LeftHandThumb0 : FullBody.FullBodyIK.BoneLocation.RightHandThumb0;
					var indexLocation = (i == 0) ? FullBody.FullBodyIK.BoneLocation.LeftHandIndex0 : FullBody.FullBodyIK.BoneLocation.RightHandIndex0;
					var middleLocation = (i == 0) ? FullBody.FullBodyIK.BoneLocation.LeftHandMiddle0 : FullBody.FullBodyIK.BoneLocation.RightHandMiddle0;
					var ringLocation = (i == 0) ? FullBody.FullBodyIK.BoneLocation.LeftHandRing0 : FullBody.FullBodyIK.BoneLocation.RightHandRing0;
					var littleLocation = (i == 0) ? FullBody.FullBodyIK.BoneLocation.LeftHandLittle0 : FullBody.FullBodyIK.BoneLocation.RightHandLittle0;
					_Prefix( ref fingerBones.thumb[n], (FullBody.FullBodyIK.BoneLocation)((int)thumbLocation + n), (n == 0) ? armBones.wrist : fingerBones.thumb[n - 1] );
					_Prefix( ref fingerBones.index[n], (FullBody.FullBodyIK.BoneLocation)((int)indexLocation + n), (n == 0) ? armBones.wrist : fingerBones.index[n - 1] );
					_Prefix( ref fingerBones.middle[n], (FullBody.FullBodyIK.BoneLocation)((int)middleLocation + n), (n == 0) ? armBones.wrist : fingerBones.middle[n - 1] );
					_Prefix( ref fingerBones.ring[n], (FullBody.FullBodyIK.BoneLocation)((int)ringLocation + n), (n == 0) ? armBones.wrist : fingerBones.ring[n - 1] );
					_Prefix( ref fingerBones.little[n], (FullBody.FullBodyIK.BoneLocation)((int)littleLocation + n), (n == 0) ? armBones.wrist : fingerBones.little[n - 1] );
				}
			}

			_Prefix( ref rootEffector, FullBody.FullBodyIK.EffectorLocation.Root );
			_Prefix( ref bodyEffectors.hips, FullBody.FullBodyIK.EffectorLocation.Hips, rootEffector, bodyBones.hips, leftLegBones.leg, rightLegBones.leg );
			_Prefix( ref headEffectors.neck, FullBody.FullBodyIK.EffectorLocation.Neck, bodyEffectors.hips, headBones.neck );
			_Prefix( ref headEffectors.head, FullBody.FullBodyIK.EffectorLocation.Head, headEffectors.neck, headBones.head );
			_Prefix( ref headEffectors.eyes, FullBody.FullBodyIK.EffectorLocation.Eyes, rootEffector, headBones.head, headBones.leftEye, headBones.rightEye );

			_Prefix( ref leftLegEffectors.knee, FullBody.FullBodyIK.EffectorLocation.LeftKnee, rootEffector, leftLegBones.knee );
			_Prefix( ref leftLegEffectors.foot, FullBody.FullBodyIK.EffectorLocation.LeftFoot, rootEffector, leftLegBones.foot );
			_Prefix( ref rightLegEffectors.knee, FullBody.FullBodyIK.EffectorLocation.RightKnee, rootEffector, rightLegBones.knee );
			_Prefix( ref rightLegEffectors.foot, FullBody.FullBodyIK.EffectorLocation.RightFoot, rootEffector, rightLegBones.foot );

			_Prefix( ref leftArmEffectors.arm, FullBody.FullBodyIK.EffectorLocation.LeftArm, bodyEffectors.hips, leftArmBones.arm );
			_Prefix( ref leftArmEffectors.elbow, FullBody.FullBodyIK.EffectorLocation.LeftElbow, bodyEffectors.hips, leftArmBones.elbow );
			_Prefix( ref leftArmEffectors.wrist, FullBody.FullBodyIK.EffectorLocation.LeftWrist, bodyEffectors.hips, leftArmBones.wrist );
			_Prefix( ref rightArmEffectors.arm, FullBody.FullBodyIK.EffectorLocation.RightArm, bodyEffectors.hips, rightArmBones.arm );
			_Prefix( ref rightArmEffectors.elbow, FullBody.FullBodyIK.EffectorLocation.RightElbow, bodyEffectors.hips, rightArmBones.elbow );
			_Prefix( ref rightArmEffectors.wrist, FullBody.FullBodyIK.EffectorLocation.RightWrist, bodyEffectors.hips, rightArmBones.wrist );

			_Prefix( ref leftHandFingersEffectors.thumb, FullBody.FullBodyIK.EffectorLocation.LeftHandThumb, leftArmEffectors.wrist, leftHandFingersBones.thumb );
			_Prefix( ref leftHandFingersEffectors.index, FullBody.FullBodyIK.EffectorLocation.LeftHandIndex, leftArmEffectors.wrist, leftHandFingersBones.index );
			_Prefix( ref leftHandFingersEffectors.middle, FullBody.FullBodyIK.EffectorLocation.LeftHandMiddle, leftArmEffectors.wrist, leftHandFingersBones.middle );
			_Prefix( ref leftHandFingersEffectors.ring, FullBody.FullBodyIK.EffectorLocation.LeftHandRing, leftArmEffectors.wrist, leftHandFingersBones.ring );
			_Prefix( ref leftHandFingersEffectors.little, FullBody.FullBodyIK.EffectorLocation.LeftHandLittle, leftArmEffectors.wrist, leftHandFingersBones.little );

			_Prefix( ref rightHandFingersEffectors.thumb, FullBody.FullBodyIK.EffectorLocation.RightHandThumb, rightArmEffectors.wrist, rightHandFingersBones.thumb );
			_Prefix( ref rightHandFingersEffectors.index, FullBody.FullBodyIK.EffectorLocation.RightHandIndex, rightArmEffectors.wrist, rightHandFingersBones.index );
			_Prefix( ref rightHandFingersEffectors.middle, FullBody.FullBodyIK.EffectorLocation.RightHandMiddle, rightArmEffectors.wrist, rightHandFingersBones.middle );
			_Prefix( ref rightHandFingersEffectors.ring, FullBody.FullBodyIK.EffectorLocation.RightHandRing, rightArmEffectors.wrist, rightHandFingersBones.ring );
			_Prefix( ref rightHandFingersEffectors.little, FullBody.FullBodyIK.EffectorLocation.RightHandLittle, rightArmEffectors.wrist, rightHandFingersBones.little );
		...
		public void CleanupBoneTransforms()
		{
			...
			if( _bones != null ) {
				for( int i = 0; i < _bones.Length; ++i ) {
					FullBody.FullBodyIK.Assert( _bones[i] != null );
					if( _bones[i] != null ) {
		...
		public void ConfigureBoneTransforms()
		{
			...
			FullBody.FullBodyIK.Assert( settings != null && rootTransform != null );
				...
				if( animator != null && animator.isHuman ) {
					...
					if( settings.automaticConfigureSpineEnabled ) {
						if( spine != null && neck != null ) {
							...
							int spineMaxLength = (int)FullBody.FullBodyIK.BoneLocation.SpineU - (int)FullBody.FullBodyIK.BoneLocation.Spine + 1;
			...
			if( settings.automaticConfigureRollBonesEnabled ) {
				...
				for( int side = 0; side != 2; ++side ) {
					...
					if( armBones != null &&
						...
						_ConfigureRollBones( armBones.armRoll, tempBones, armBones.arm.transform, armBones.elbow.transform, (FullBody.FullBodyIK.Side)side, true );
						_ConfigureRollBones( armBones.elbowRoll, tempBones, armBones.elbow.transform, armBones.wrist.transform, (FullBody.FullBodyIK.Side)side, false );
					}
				}
			}
		}

		void _ConfigureRollBones( FullBody.FullBodyIK.Bone[] bones, List<Transform> tempBones, Transform transform, Transform excludeTransform, FullBody.FullBodyIK.Side side, bool isArm )
		{
			bool isRollSpecial = false;
			string rollSpecialName = null;
			if( isArm ) {
				rollSpecialName = (side == FullBody.FullBodyIK.Side.Left) ? "LeftArmRoll" : "RightArmRoll";
			} else {
				rollSpecialName = (side == FullBody.FullBodyIK.Side.Left) ? "LeftElbowRoll" : "RightElbowRoll";
			}
		...
		public bool Prepare()
		{
			...
			FullBody.FullBodyIK.Assert( rootTransform != null );
			if( rootTransform != null ) { // Failsafe.
				internalValues.defaultRootPosition = rootTransform.position;
				internalValues.defaultRootBasis = FullBody.FullBodyIK.Matrix3x3.FromColumn( rootTransform.right, rootTransform.up, rootTransform.forward );
			...
			if( _effectors != null ) {
                ...
                for( int i = 0; i != effectorLength; ++i ) {
					FullBody.FullBodyIK.Assert( _effectors[i] != null );
			...
			if( _limbIK == null || _limbIK.Length != (int)FullBody.FullBodyIK.LimbIKLocation.Max ) {
				_limbIK = new FullBody.FullBodyIK.LimbIK[(int)FullBody.FullBodyIK.LimbIKLocation.Max];
			}

			for( int i = 0; i != (int)FullBody.FullBodyIK.LimbIKLocation.Max; ++i ) {
				_limbIK[i] = new FullBody.FullBodyIK.LimbIK( this, (FullBody.FullBodyIK.LimbIKLocation)i );
			}

			_bodyIK = new FullBody.FullBodyIK.BodyIK( this, _limbIK );
			_headIK = new FullBody.FullBodyIK.HeadIK( this );

			if( _fingerIK == null || _fingerIK.Length != (int)FullBody.FullBodyIK.FingerIKType.Max ) {
				_fingerIK = new FullBody.FullBodyIK.FingerIK[(int)FullBody.FullBodyIK.FingerIKType.Max];
			}

			for( int i = 0; i != (int)FullBody.FullBodyIK.FingerIKType.Max; ++i ) {
				_fingerIK[i] = new FullBody.FullBodyIK.FingerIK( this, (FullBody.FullBodyIK.FingerIKType)i );
			}

			{
				FullBody.FullBodyIK.Bone neckBone = headBones.neck;
				FullBody.FullBodyIK.Bone leftShoulder = leftArmBones.shoulder;
				FullBody.FullBodyIK.Bone rightShoulder = rightArmBones.shoulder;
		...
		void _ComputeBaseHipsTransform()
		{
			...
			FullBody.FullBodyIK.Effector hipsEffector = bodyEffectors.hips;
			if( hipsEffector == null || rootEffector == null ) {
				return;
			}

			if( hipsEffector.rotationEnabled && hipsEffector.rotationWeight > FullBody.FullBodyIK.IKEpsilon ) {
				Quaternion hipsRotation = hipsEffector.worldRotation * FullBody.FullBodyIK.Inverse( hipsEffector._defaultRotation );
				if( hipsEffector.rotationWeight < 1.0f - FullBody.FullBodyIK.IKEpsilon ) {
					Quaternion rootRotation = rootEffector.worldRotation * FullBody.FullBodyIK.Inverse( rootEffector._defaultRotation );
					Quaternion tempRotation = Quaternion.Lerp( rootRotation, hipsRotation, hipsEffector.rotationWeight );
					FullBody.FullBodyIK.SAFBIKMatSetRot( out internalValues.baseHipsBasis, ref tempRotation );
				} else {
					FullBody.FullBodyIK.SAFBIKMatSetRot( out internalValues.baseHipsBasis, ref hipsRotation );
				}
			} else {
				Quaternion rootEffectorWorldRotation = rootEffector.worldRotation;
				FullBody.FullBodyIK.SAFBIKMatSetRotMultInv1( out internalValues.baseHipsBasis, ref rootEffectorWorldRotation, ref rootEffector._defaultRotation );
			}

			if( hipsEffector.positionEnabled && hipsEffector.positionWeight > FullBody.FullBodyIK.IKEpsilon ) {
				Vector3 hipsEffectorWorldPosition = hipsEffector.worldPosition;
				internalValues.baseHipsPos = hipsEffectorWorldPosition;
				if( hipsEffector.positionWeight < 1.0f - FullBody.FullBodyIK.IKEpsilon ) {
					Vector3 rootEffectorWorldPosition = rootEffector.worldPosition;
					Vector3 hipsPosition;
					FullBody.FullBodyIK.SAFBIKMatMultVecPreSubAdd(
						out hipsPosition,
		...
		public void Update()
		{
			...
			if( _effectors != null ) {
				int effectorLength = _effectors.Length;
				for( int i = 0; i != effectorLength; ++i ) {
					FullBody.FullBodyIK.Effector effector = _effectors[i];
					if( effector != null ) {
						...
						// FingerIK : nothing
						if( effector.effectorType == FullBody.FullBodyIK.EffectorType.Eyes ||
							effector.effectorType == FullBody.FullBodyIK.EffectorType.HandFinger ) { // Optimize.
#if SAFULLBODYIK_DEBUG
							effector._hidden_worldPosition = new Vector3();
#endif
						} else {
							float weight = effector.positionEnabled ? effector.positionWeight : 0.0f;
							Vector3 destPosition = (weight > FullBody.FullBodyIK.IKEpsilon) ? effector.worldPosition : new Vector3();
							if( weight < 1.0f - FullBody.FullBodyIK.IKEpsilon ) {
								...
								if( !internalValues.animatorEnabled && (internalValues.resetTransforms || internalValues.continuousSolverEnabled) ) {
									if( effector.effectorLocation == FullBody.FullBodyIK.EffectorLocation.Hips ) {
										sourcePosition = internalValues.baseHipsPos; // _ComputeBaseHipsTransform()
									} else {
										FullBody.FullBodyIK.Effector hipsEffector = (bodyEffectors != null) ? bodyEffectors.hips : null;
								...
								if( weight > FullBody.FullBodyIK.IKEpsilon ) {
		...
		static void _DrawEffectorGizmo( FullBody.FullBodyIK.Effector effector )
		{
			if( effector != null ) {
				bool isFinger = (effector.bone != null && effector.bone.boneType == FullBody.FullBodyIK.BoneType.HandFinger);
		...
		void _DrawBoneGizmo( FullBody.FullBodyIK.Bone bone, ref Vector3 cameraForward )
		{
			if( bone == null || bone.transform == null ) {
				return;
			}

			if( bone.boneType == FullBody.FullBodyIK.BoneType.Eye ) {
			...
			FullBody.FullBodyIK.Matrix3x3 basis;
			FullBody.FullBodyIK.SAFBIKMatSetRot( out basis, ref rotation );
		...
		static void _DrawTransformGizmo( Vector3 position, ref FullBody.FullBodyIK.Matrix3x3 basis, ref Vector3 cameraForward, FullBody.FullBodyIK.BoneType boneType )
		{
		...
		static void _DrawArrowGizmo(
			...
			FullBody.FullBodyIK.BoneType boneType )
		{
			Vector3 nY = Vector3.Cross( cameraForward, direction );
			if( FullBody.FullBodyIK.SAFBIKVecNormalize( ref nY ) ) {
				Gizmos.color = color;
				...
				if( boneType == FullBody.FullBodyIK.BoneType.HandFinger ) {
					gizmoScale = _ArrowGizmoFingerScale;
				}
				if( boneType == FullBody.FullBodyIK.BoneType.Eye ) {
		...
		static void _DrawBoneGizmo( Vector3 fromPosition, Vector3 toPosition, ref FullBody.FullBodyIK.Matrix3x3 basis, ref Vector3 cameraForward, FullBody.FullBodyIK.BoneType boneType )
		{
			Vector3 dir = toPosition - fromPosition;
			if( FullBody.FullBodyIK.SAFBIKVecNormalize( ref dir ) ) {
		...
		void _Prefix( ref FullBody.FullBodyIK.Bone bone, FullBody.FullBodyIK.BoneLocation boneLocation, FullBody.FullBodyIK.Bone parentBoneLocationBased )
		{
			FullBody.FullBodyIK.Assert( _bones != null );
			FullBody.FullBodyIK.Bone.Prefix( _bones, ref bone, boneLocation, parentBoneLocationBased );
		}

		void _Prefix(
			ref FullBody.FullBodyIK.Effector effector,
			FullBody.FullBodyIK.EffectorLocation effectorLocation )
		{
			FullBody.FullBodyIK.Assert( _effectors != null );
			bool createEffectorTransform = this.settings.createEffectorTransform;
			FullBody.FullBodyIK.Assert( rootTransform != null );
			FullBody.FullBodyIK.Effector.Prefix( _effectors, ref effector, effectorLocation, createEffectorTransform, rootTransform );
		}

		void _Prefix(
			ref FullBody.FullBodyIK.Effector effector,
			FullBody.FullBodyIK.EffectorLocation effectorLocation,
			FullBody.FullBodyIK.Effector parentEffector,
			FullBody.FullBodyIK.Bone[] bones )
		{
		...
		void _Prefix(
			...
			FullBody.FullBodyIK.EffectorLocation effectorLocation,
			FullBody.FullBodyIK.Effector parentEffector,
			FullBody.FullBodyIK.Bone bone,
			FullBody.FullBodyIK.Bone leftBone = null,
			FullBody.FullBodyIK.Bone rightBone = null )
		{
			FullBody.FullBodyIK.Assert( _effectors != null );
			bool createEffectorTransform = this.settings.createEffectorTransform;
			FullBody.FullBodyIK.Effector.Prefix( _effectors, ref effector, effectorLocation, createEffectorTransform, null, parentEffector, bone, leftBone, rightBone );
		}
		...
		public virtual void _SolveCustomEyes( ref FullBody.FullBodyIK.Matrix3x3 neckBasis, ref FullBody.FullBodyIK.Matrix3x3 headBasis, ref FullBody.FullBodyIK.Matrix3x3 headBaseBasis )
		{
		}
	}
}
